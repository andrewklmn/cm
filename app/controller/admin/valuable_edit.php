 ...
 */
        ...
        $data['title'] = $_SESSION[$program]['lang']['valuable_edit_title'];
        ...
        if ( $row[0] > 0){
            ...
            <div class="container">
                <div class="alert alert-error">  
                  ...
                  <br/>
                      <?php echo htmlfix($_SESSION[$program]['lang']['valuable_edit_can_not_edit']); ?>
                </div> 
                <br/>
                <a 
        ...
        include 'app/model/record/admin_valuable_record.php';
