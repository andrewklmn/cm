 ...
 */
        ...
        // Блокируем таблицу
        do_sql('LOCK TABLES DepositCurrencyTotal WRITE,SorterIndexes WRITE,DepositRuns WRITE, DepositDenomTotal WRITE, DepositRecs WRITE, ReconAccountingData WRITE;');
        ...
        if ($row[0]>0) {
            ...
            if ((int)$row[3]==(int)$_REQUEST['oldvalue']
                ...
                echo '1';
                echo (int)$row[3],'|',$row[4],'|',get_recon_data_map_by_rec_id($_REQUEST['deposit_rec_id']);
            };
