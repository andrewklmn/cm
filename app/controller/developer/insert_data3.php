...
<?php
            ...
            echo 'Stage 3 in progress... please, wait.<br/> ';

            $file = 'DATA_INSERT_PART_3.sql';
    ...
    if ($status==0) {
        ?>
            <h3>Part 3 was inserted</h3>
            <br/>
            <br/>

            <a style='width:150px;' 
               onclick="$('body').html('Update 4 in progress... please, wait.<br/> ');"
               class="btn btn-primary btn-large" href="?c=insert_data4">Next update step</a>           
        <?php
    } else {
        ?>
