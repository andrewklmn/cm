 ...
 */
        ...
        if (!isset($_GET['name'])) {
            $data['title'] = 'Edit raw table data';
        ...
        if (!check_table_exist($_GET['name'])) {
            $data['title'] = 'Edit "'.$_GET['name'].'" table data';
            include './app/view/page_header_with_logout.php';
        ...
        $data['title'] = 'Edit raw "'.$_GET['name'].'" table data';
        include './app/view/page_header_with_logout.php';
...
<div class='container'>
    <?php 
        ...
        if (isset($_POST['action']) AND $_POST['action']=='add_new') {
            include 'app/controller/developer/edit_raw_table_add.php';
        };
                    ...
                    if (isset($_GET['order']) AND $value[0]==$_GET['order']) {
                        if (isset($_GET['sort']) AND $_GET['sort']=='ASC') {
                            echo '<th style="padding:3px; font-size:11px; border: 2px solid black;">
                                    <a onclick="set_wait();" href="?c=edit_raw_table&name=',htmlfix($_GET['name']),'&order=',$value[0],'&sort=DESC">
                            ...
                            echo '<th style="padding:3px; font-size:11px; border: 2px solid black;">
                                    <a onclick="set_wait();" href="?c=edit_raw_table&name=',htmlfix($_GET['name']),'&order=',$value[0],'&sort=ASC">
