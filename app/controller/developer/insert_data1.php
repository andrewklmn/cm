...
<?php
            ...
            echo 'Stage 1 in progress... please, wait.<br/> ';
            
            $file = 'DATA_INSERT_PART_1.sql';
    ...
    if ($status==0) {
        ?>
            <h3>Part 1 was inserted</h3>
            <br/>
            <br/>

            <a style='width:150px;' 
               onclick="$('body').html('Update 2 in progress... please, wait.<br/> ');"
               class="btn btn-primary btn-large" href="?c=insert_data2">Next update step</a>           
        <?php
    } else {
        ?>
