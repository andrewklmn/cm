            ...
            <td> 
                <div class="input-append date" id="dp3" data-date-format="yyyy-mm-dd" style="padding: 0px;margin: 0px;">
                    <input 
                           ...
                           oldvalue="<?php echo ($DepositRec['DepositPackingDate']=='0000-00-00')?'':$DepositRec['DepositPackingDate']; ?>"
                           value="<?php echo ($DepositRec['DepositPackingDate']=='0000-00-00')?'':$DepositRec['DepositPackingDate']; ?>"/>
