 ...
 */
        ...
        $data['error'] = "Неподходящий класс в данных ручного ввода: "
                        .implode(',',$extra_recon_grades)
                        .'.<br/>Сначала очистите данные ручного ввода по предыдущему сценарию.'
                        .'<br/>Использованый режим работы машины:'.$t;;
