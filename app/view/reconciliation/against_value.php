...
<script>
            function recon(elem) {
                    ...
                    for (var c=0; c < currency.length; c++){
                        ...
                        var entered = parseFloat($(currency[c].parentNode).find('span.total')[2].innerHTML);
                        var estimated = parseFloat($(currency[c].parentNode).find('input#estimated')[0].value);
                        
                        if (entered > estimated) {
                            over[over.length] = [
                                currency_name[c].value,entered-estimated
                            ];
                        } else {
                            if (entered < estimated) {
                                deficit[over.length] = [
                                    currency_name[c].value,estimated-entered
                                ];
                            };
                        };
                    };
                       ...
                       foreach ($denoms as $denom_key=>$denom) {
                        ...
                        ?>
                          <tr>
                              <td>
                                  ...
                                  ?>
                                    ...
                                    ?>vertical-align: top;padding-right:30px;"><?php
                                        include './app/view/reconciliation/value/sorter_data_form.php';
                                    ?></td>
                                    <?php 
                                    if($sorter_grades_is_ok==true 
                                            AND $sorter_data_is_ok==true
                                    ...
                                    ?>
                                        <td style="vertical-align: top;padding-right:30px;"><?php 
                                            include './app/view/reconciliation/value/recon_data_input_form.php';
                                        ?></td>
                                        <td style="vertical-align: top;"><?php 
                                            include './app/view/reconciliation/value/recon_data_total.php';
                                        ?></td>
                                    <?php
                                };
                            ?>
                            ...
                            <tr>
                                <?php 
                                    include 'app/view/reconciliation/value/result_and_estimated.php';
                                ?>
                            </tr>
                        </table>
                        <br/>
...
<div class="container">
    <?php
        include './app/view/reconciliation/value/discrepancies.php';
