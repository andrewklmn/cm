 ...
 */
    ...
    function get_reconciled_deposit_by_sort_card_number($card_number) {
        
        global $db;
        global $program;
        
        $DepositRec = get_reconciliation_by_sort_card_number($card_number,1);
        //print_r($DepositRec);
        //exit;
        ...
        $sql = '
            SELECT
             ...
             WHERE
                    ...
                    AND `DepositRuns`.`DepositRecId`="'.$DepositRec['DepositRecId'].'"
